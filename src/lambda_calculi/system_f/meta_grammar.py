...
class TypeVariableSubstitution(MetaGrammar):
    def __init__(self, type1: grammar.Type, type_var: grammar.TypeVariable, type2: grammar.Type):
        self.type1 = type1
...
class VariableSubstitution(MetaGrammar):
    def __init__(self, expr1: grammar.Expression, var: grammar.Variable, expr2: grammar.Expression):
        self.expr = expr1
        self.var = var
        self.expr2 = expr2
    def __str__(self):
...
class TypeExpressionSubstitution(MetaGrammar):
    def __init__(self, expr: grammar.Expression, type_var: grammar.TypeVariable, type: grammar.Type):
        self.expr = expr
        self.type_var = type_var
        self.type = type
    def __str__(self):
