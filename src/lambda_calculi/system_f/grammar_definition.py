...
kinds = meta_grammar.DefinedAs(Kind.KAPPA, meta_grammar.Or(
    Kind.STAR,
    grammar.FunctionKind(Kind.KAPPA1, Kind.KAPPA2),
))

types = meta_grammar.DefinedAs(Type.TAU, meta_grammar.Or(
    Type.ALPHA,
...
terms = meta_grammar.DefinedAs(Expr.E, meta_grammar.Or(
    Expr.X,
...
environments = meta_grammar.DefinedAs(Env.GAMMA, meta_grammar.Or(
    Env.EMPTY,
